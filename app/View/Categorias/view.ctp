<!-- app/View/Categorias/view.ctp
     Se muestran las preguntas que pertenecen a la categoria seleccionada -->

<!-- Contenido Principal -->
<div class="col-xs-12 col-sm-12 col-md-12">
  <div class="index-phrase opSansBFontTitle pcolor"><?php echo 'Categoria: ' .$categoria; ?></div>
