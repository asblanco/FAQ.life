...
<div class="col-xs-12 col-sm-12 col-md-12">
  ...
  <div class="col-xs-12 col-sm-12 col-md-12">
    ...
    <div class="col-xs-12 col-sm-8 col-md-8" id="caja-pregunta">
      ...
      <?php echo $this->Form->textarea('cuerpo_res', array('class' => 'form-control respuestaCuerpo opSansLiFont', 'rows' => 4, 'placeholder' => __('Answer'))); ?>
      <!-- <button type="submit" class="btn-login button-preguntar">Responder!</button> -->
      <?php echo $this->Form->hidden('id',array('value' => $pregunta['Pregunta']['id'])); ?>
      <?php echo $this->Form->submit(__('Response!'), array('class' => 'btn-login button-preguntar')); ?>
    </div>
    <div class="col-xs-12 col-sm-2 col-md-2"></div>
  </div>
  ...
  <div class="col-xs-12 col-sm-8 col-md-8 col-sm-offset-2">
    <p class="opSansReFont"> <?php echo __('This question hasn\'t been answered yet. Be the first!') ?></p>
  </div>
  <?php } ?>
    ...
    <div class="col-xs-12 col-sm-8 col-md-8"> <!-- nested grid - answers -->
      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-9 col-md-10">
          ...
          <p class="opSansItFont"><?php echo __('Responding by') ?><a href="">
              <?php echo $usu['Usuario']['username']; ?>
            </a> <?php echo __('at') ?> <?php echo $this->Time->format($respuesta['fecha_res'], '%e %B %Y %H:%M'); echo " "; echo __('hours')?></p>
          <?php }
                } ?>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
